...
/// <summary>
/// The fragment shader the Avalonia shader example post-processes its surface with: a hologram effect
/// built from a travelling horizontal wobble, a chromatic split and scanlines.
/// </summary>
/// <remarks>
...
public static class AvaloniaHologramShader
{
    ...
    /// <remarks>
    /// Compiled from source rather than loaded from the resource pack so the shader stays next to the
    /// example explaining it. A real game would put it in <c>Resources/Shaders</c> with the others.
    /// </remarks>
