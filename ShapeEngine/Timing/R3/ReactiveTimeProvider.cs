...
public class ReactiveTimeProvider : TimeProvider, IDisposable
{
    public static readonly ReactiveTimeProvider Update = new();
...
internal sealed class FrameTimer : ITimer
{
    ...
    readonly ReactiveTimeProvider timeProvider;
    ...
    public FrameTimer(TimerCallback callback, object? state, TimeSpan dueTime, TimeSpan period, ReactiveTimeProvider timeProvider)
    {
    ...
    public bool Tick(GameTime gameTime)
    {
        ...
        elapsed += gameTime.ElapsedSeconds; // ElapsedGameTime is delta time
