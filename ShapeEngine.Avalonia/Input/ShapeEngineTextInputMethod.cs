...
/// </summary>
/// <remarks>
/// There is no IME to drive here. This exists because Avalonia calls <see cref="SetClient"/> with a
/// non-null client exactly when a control (a <c>TextBox</c>, say) wants typed characters, which is a
/// far better signal for "the UI needs the keyboard" than "something has focus" - a focused button
/// should not stop the game from seeing WASD.
/// </remarks>
